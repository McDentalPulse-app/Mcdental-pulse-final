...
const ENDPOINTS = ['gemini', 'soporte-ticket', 'checar', 'reto', 'enrolar-rostro', 'aprobar-rostro', 'resolver', 'enviar-mensaje', 'suscribir-push', 'limpiar-fotos', 'solicitar-intercambio', 'crear-reunion', 'eliminar-mensaje', 'idea-mejora', 'limpiar-adjuntos', 'respaldo-latido', 'reunion-token', 'revisar-respaldos', 'tareas-programadas']
