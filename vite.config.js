...
const ENDPOINTS = ['gemini', 'soporte-ticket', 'checar', 'reto', 'enrolar-rostro', 'aprobar-rostro', 'resolver', 'enviar-mensaje', 'suscribir-push', 'limpiar-fotos', 'solicitar-intercambio']
